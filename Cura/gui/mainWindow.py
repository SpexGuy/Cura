...
class mainWindow(wx.Frame):
	def __init__(self):
		...
		self.Bind(wx.EVT_MENU, lambda e: webbrowser.open('mailto:orders@spectrom.com'), i)
		i = helpMenu.Append(-1, _("Check for updates..."))
		self.Bind(wx.EVT_MENU, self.OnCheckForUpdate, i)
		i = helpMenu.Append(-1, _("Open Spectrom website..."))
		self.Bind(wx.EVT_MENU, lambda e: webbrowser.open('http://spectrom3D.com/'), i)
		i = helpMenu.Append(-1, _("About Cura..."))
		self.Bind(wx.EVT_MENU, self.OnAbout, i)
		i = helpMenu.Append(-1, _("View Source..."))
		self.Bind(wx.EVT_MENU, lambda e: webbrowser.open('http://github.com/SpexGuy/Cura/tree/Simplify'), i)
