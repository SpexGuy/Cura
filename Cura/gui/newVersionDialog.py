...
class newVersionDialog(wx.Dialog):
	def __init__(self):
		...
		title = wx.StaticText(p, -1, 'Spectrom Cura - ' + version.getVersion())
		...
		s.Add(wx.StaticText(p, -1, '* Added Coloring Controls'))
		s.Add(wx.StaticText(p, -1, '* Integrated Spectrom Order Bureau'))
